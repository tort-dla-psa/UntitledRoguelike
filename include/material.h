...
std::shared_ptr<const material::color_t> material::color()const
{ return this->m_color; }

std::shared_ptr<material::color_t> material::color()
{ return this->m_color; }

void material::set_color(const material::color_t& color)
{ this->m_color = std::make_shared<material::color_t>(color); }

void material::set_color(std::shared_ptr<material::color_t> color)
{ this->m_color = color; }
...
const material::temp_t& material::plasma_to_gas()const
{ return m_plasma_to_gas; }
...
void material::set_plasma_to_gas(const material::temp_t &t)
{ this->m_plasma_to_gas = t; }
